        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <p className="text-white/45 leading-relaxed text-sm font-light max-w-sm">
              Luxora Interiors creates premium residential and commercial spaces with a perfect
              blend of luxury, functionality and modern design. From concept to execution, we
              deliver thoughtfully designed interiors tailored to your lifestyle.
            </p>
            {/* Social Icons */}
            <div className="flex gap-3 mt-8">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center text-white/40 hover:text-luxora-gold hover:border-luxora-gold hover:shadow-[0_0_15px_rgba(212,175,55,0.2)] transition-all duration-400 group"
          ...
          {/* ───── Column 2: Services ───── */}
          <div>
            <h3 className="text-sm font-semibold text-white/80 tracking-[0.15em] uppercase mb-8 border-b border-white/[0.06] pb-3">
              Services
            </h3>
            <ul className="space-y-3.5">
              {services.map((item) => (
                <li key={item}>
                  <a
                    href="#"
                    className="text-white/40 hover:text-luxora-gold text-sm transition-colors duration-300 hover:translate-x-1 inline-block"
                  >
                    {item}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-[10px] tracking-[0.15em] uppercase text-white/30 font-semibold block mb-0.5">Email</span>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-[10px] tracking-[0.15em] uppercase text-white/30 font-semibold block mb-0.5">Phone</span>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-[10px] tracking-[0.15em] uppercase text-white/30 font-semibold block mb-0.5">Location</span>
