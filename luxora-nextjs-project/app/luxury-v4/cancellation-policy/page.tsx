...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/luxury-v4/cancellation-policy' },
};
    ...
    <ServicePageShell>
      <LegalPageLayout title="Cancellation Policy" updated="2 July 2026">
        ...
        <LegalSection title="Booked Projects">
          ...
          />
          <p>See our <a href="/luxury-v4/refund-policy" className="underline">Refund Policy</a> for how payments already made are treated.</p>
        </LegalSection>
