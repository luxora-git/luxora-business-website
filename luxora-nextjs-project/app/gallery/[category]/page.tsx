  ...
  return (
    <ServicePageShell>
      ...
      <PageHero
        ...
        breadcrumbItems={[{ label: 'Home', href: '/' }, { label: 'Gallery', href: '/gallery' }, { label: category.label }]}
      />
      ...
      {secondary && (
        <GallerySection spacing="standard" background={luxoraColors.warmCream}>
          <GalleryEditorialCard
            href={`/gallery/${category.slug}/${secondary.slug}`}
      ...
      <GallerySection spacing="tight" background={luxoraColors.ivory}>
        ...
        <div className="flex flex-wrap gap-3">
          {galleryStyles.map((style) => (
            <Link
              key={style.slug}
              href={`/gallery?style=${encodeURIComponent(style.label)}#gallery-browser`}
      ...
      {/* Related Categories */}
      <GallerySection spacing="standard" background={luxoraColors.warmCream}>
        <GalleryRail eyebrow="Explore More" title="Related Categories" viewAllHref="/gallery" viewAllLabel="All Categories" cardWidth={260}>
