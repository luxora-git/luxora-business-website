/**
 * Official Luxora contact details and external links — single source of
 * truth for the entire V4 website (homepage + every service page).
 *
 * Update values here only; every footer, CTA, sticky bar and consultation
 * modal reads from this file so there is never a stale number/email/link
 * anywhere on the site.
 */

export const luxoraContact = {
  phone: {
    display: '+91 73399 93930',
    href: 'tel:+917339993930',
  },
  email: {
    display: 'hello@luxora.in',
    href: 'mailto:hello@luxora.in',
  },
  whatsapp: {
    href: 'https://wa.me/917339993930',
  },
} as const;
...
export const luxoraSocialLinks = [
  ...
  {
    name: 'YouTube',
    href: 'https://www.youtube.com/@Luxorainteriors',
